<template>
  <ClientOnly>
    ...
    <DynamicLogo :custom-url="url" text-color="white" logo-color="white" class="absolute left-1/2 top-1/2 h-fit w-full -translate-x-1/2  -translate-y-1/2  px-40 child:h-96 " />
  </ClientOnly>
</template>
