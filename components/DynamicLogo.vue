  ...
  >
    <svg class="size-full" :viewBox="`0 0 ${90+regionTextWidth} 63`" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        ><tspan x="74.5" y="29.9475">{{ getBrandName }}<tspan v-if="isRegistered" font-size="16" dy="-10">&#xae;</tspan></tspan></text>
      </g>
...
const isRegistered = computed(() => {
  return props.registered || (store.region?.brandName === getBrandName.value && store.region?.brandNameRegistered)
})
