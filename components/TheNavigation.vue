    ...
    >
      ...
      >
        <transition mode="out-in" name="slide-fade">
          <svg v-if="!useRoute().path.includes('cities')" class="h-32" viewBox="0 0 500 59" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg v-else class="h-32" viewBox="0 0 500 63" fill="none" xmlns="http://www.w3.org/2000/svg">
            <text
              fill="black"
              xml:space="preserve"
              style="white-space: pre"
