  ...
  >
    ...
    <div class="relative">
      ...
      <button v-if="activeIndex > 0"
          ...
          @click="goToPrevious">
          <svg class="cursor-pointer" width="20" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      >
        ...
        <div class="absolute w-full h-8 rounded pointer-events-none">
          <div
            ...
            :style="`margin-left: ${16 * activeIndex}px; width: ${ 0.5}rem;`"></div>
        </div>
      </div>
    </div>
  </div>
...
useEventListener('resize', onWindowResize, undefined, { immediate: true, passive: true })
